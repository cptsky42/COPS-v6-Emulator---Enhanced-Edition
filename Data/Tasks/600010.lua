...
function processTask600010(client, idx)
    name = "GuardianGod"
    face = 1
    ...
    elseif (idx == 1) then
        ...
        if hasItem(client, 721013, 1) then
            ...
            text(client, "Since you have got a token, I am glad to tell you that this is Prosperous Tactic. You may ask Ghost to teleport you to Maggie.")
