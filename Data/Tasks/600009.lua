...
function processTask600009(client, idx)
    name = "Ghost"
    face = 1
    ...
    elseif (idx == 1) then
        ...
        if hasItem(client, 721012, 1) then
            ...
            text(client, "Wow! You have a token for Deserted Tactic. My only wish is to see a person break through the tactics. I hope you can succeed.")
