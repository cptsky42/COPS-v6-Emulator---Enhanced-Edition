...
function processTask600006(client, idx)
    name = "GuardianGod"
    face = 1
    ...
    elseif (idx == 1) then
        ...
        if hasItem(client, 721011, 1) then
            ...
            text(client, "Since you have got a token, I am glad to tell you that this is Chaos Tactic. You may ask Ghost to teleport you to Maggie.")
