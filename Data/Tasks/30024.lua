...
function processTask30024(client, idx)
    name = "EvilHawk"
    face = 1
    ...
    if (idx == 0) then
        ...
        if hasItem(client, 721154, 1) then
            ...
            if getLevel(client) < 80 then
                ...
                text(client, "This is the third floor. I may teleport you to the next floor directly, or to the battle stage. Are you ready?")
                ...
                if getLevel(client) < 101 then
                    ...
                    text(client, "This floor is for those who are between level 80 and 100.")
