...
function processTask600013(client, idx)
    name = "Ghost"
    face = 1

    if (idx == 0) then

        text(client, "I have been trapped here for many years. Many challengers have come but failed. When can I see a person conquer this tactic?")
    ...
    elseif (idx == 1) then
        ...
        if hasItem(client, 721014, 1) then
            ...
            text(client, "Wow! You have a token for Disturbed Tactic. My only wish is to see a person break through this tactic. I hope you can succeed.")
    ...
    elseif (idx == 4) then
        ...
        text(client, "Although I cannot help you break through this tactic, but I can help you leave here. I hope you can conquer this tactic soon.")
