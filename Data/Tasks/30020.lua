...
function processTask30020(client, idx)
    name = "StageGuard"
    face = 1

    if (idx == 0) then

        if hasItem(client, 721101, 1) then
    ...
    elseif (idx == 1) then
        ...
        if hasTaskItem(client, "PassToken2") and (getMoney(client) >= 0) then

            spendItem(client, 721101, 1)
