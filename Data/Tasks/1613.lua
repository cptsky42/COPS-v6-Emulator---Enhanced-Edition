...
-- the 3/30/2015 7:46:15 PM.
--
-- Please read the WARNING, DISCLAIMER and PATENTS
-- sections in the LICENSE file.
--

function processTask1613(client, idx)
    name = "BlueMouse"
    face = 1
    ...
    if (idx == 0) then
        ...
        if action == 1 then
            moveNpc(client, 1613, 2006, 98, 143)
        ...
        elseif action == 2 then
            moveNpc(client, 1613, 2002, 75, 100)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 3 then
            moveNpc(client, 1613, 2004, 120, 149)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 4 then
            moveNpc(client, 1613, 2011, 66, 75)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 5 then
            moveNpc(client, 1613, 2009, 120, 149)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 6 then
            moveNpc(client, 1613, 2007, 81, 81)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 7 then
            moveNpc(client, 1613, 2005, 119, 166)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 8 then
            moveNpc(client, 1613, 2000, 71, 100)
            if hasItem(client, 722511, 1) then
