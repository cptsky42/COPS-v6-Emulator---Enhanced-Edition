...
function processTask20060(client, idx)
    name = "ArenaGuard"
    face = 1
    ...
    elseif (idx == 1) then
        ...
        if action == 1 then
            move(client, 1090, 101, 75)
        elseif action == 2 then
            move(client, 1090, 80, 63)
        elseif action == 3 then
            move(client, 1090, 54, 53)
        elseif action == 4 then
            move(client, 1090, 101, 75)
        elseif action == 5 then
            move(client, 1090, 104, 113)
    ...
    elseif (idx == 2) then
        ...
        action = randomAction(client, 1, 8)
        if action == 1 then
            move(client, 1091, 31, 30)
        elseif action == 2 then
            move(client, 1091, 31, 30)
        elseif action == 3 then
            move(client, 1091, 32, 23)
        elseif action == 4 then
            move(client, 1091, 32, 23)
        elseif action == 5 then
            move(client, 1091, 31, 30)
