...
function processTask600007(client, idx)
    name = "Ghost"
    face = 1
    ...
    elseif (idx == 1) then
        ...
        if hasItem(client, 721011, 1) then
            ...
            text(client, "Wow! You have a token for Chaos Tactic. My only wish is to see a person break through the tactics. I hope you can succeed.")
