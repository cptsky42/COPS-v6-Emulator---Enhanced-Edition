...
-- the 3/30/2015 7:46:20 PM.
--
-- Please read the WARNING, DISCLAIMER and PATENTS
-- sections in the LICENSE file.
--

function processTask1615(client, idx)
    name = "BlueMouse"
    face = 1
    ...
    if (idx == 0) then
        ...
        if action == 1 then
            moveNpc(client, 1615, 2000, 111, 134)
        ...
        elseif action == 2 then
            moveNpc(client, 1615, 2001, 83, 132)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 3 then
            moveNpc(client, 1615, 2002, 120, 149)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 4 then
            moveNpc(client, 1615, 2004, 75, 100)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 5 then
            moveNpc(client, 1615, 2005, 111, 134)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 6 then
            moveNpc(client, 1615, 2006, 75, 100)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 7 then
            moveNpc(client, 1615, 2009, 71, 100)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 8 then
            moveNpc(client, 1615, 2007, 98, 143)
            if hasItem(client, 722511, 1) then
