...
-- the 3/30/2015 7:46:25 PM.
--
-- Please read the WARNING, DISCLAIMER and PATENTS
-- sections in the LICENSE file.
--

function processTask1617(client, idx)
    name = "BlueMouse"
    face = 1
    ...
    if (idx == 0) then
        ...
        if action == 1 then
            moveNpc(client, 1617, 2000, 98, 143)
        ...
        elseif action == 2 then
            moveNpc(client, 1617, 2001, 75, 100)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 3 then
            moveNpc(client, 1617, 2002, 111, 134)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 4 then
            moveNpc(client, 1617, 2006, 66, 75)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 5 then
            moveNpc(client, 1617, 2005, 98, 103)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 6 then
            moveNpc(client, 1617, 2007, 120, 149)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 7 then
            moveNpc(client, 1617, 2009, 111, 134)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 8 then
            moveNpc(client, 1617, 2011, 98, 103)
            if hasItem(client, 722511, 1) then
