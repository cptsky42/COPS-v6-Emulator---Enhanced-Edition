...
-- the 3/30/2015 7:46:23 PM.
--
-- Please read the WARNING, DISCLAIMER and PATENTS
-- sections in the LICENSE file.
--

function processTask1616(client, idx)
    name = "BlueMouse"
    face = 1
    ...
    if (idx == 0) then
        ...
        if action == 1 then
            moveNpc(client, 1616, 2000, 120, 149)
        ...
        elseif action == 2 then
            moveNpc(client, 1616, 2001, 119, 166)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 3 then
            moveNpc(client, 1616, 2002, 119, 166)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 4 then
            moveNpc(client, 1616, 2004, 66, 75)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 5 then
            moveNpc(client, 1616, 2005, 71, 100)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 6 then
            moveNpc(client, 1616, 2006, 83, 132)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 7 then
            moveNpc(client, 1616, 2007, 111, 134)
            if hasItem(client, 722511, 1) then
        ...
        elseif action == 8 then
            moveNpc(client, 1616, 2011, 119, 166)
            if hasItem(client, 722511, 1) then
