...
-- the 5/21/2015 11:49:57 AM.
--
-- Please read the WARNING, DISCLAIMER and PATENTS
-- sections in the LICENSE file.
--

function processTask32(client, idx)
    name = "GeneralWinner"
    face = 1
    ...
    if (idx == 0) then
        ...
        if checkTime(client, 2, "1 21:10 1 21:27") then
            ...
            if alivePlayersOnMap(client, 1528) == 1 then
                ...
                text(client, "If you defeat all the challengers in the arena, you can come to claim your prize within the tournament period.")
            ...
            if checkTime(client, 3, "6 21:10 6 21:27") then
                ...
                if alivePlayersOnMap(client, 1528) == 1 then
                    ...
                    text(client, "Congrats. You are the champion of the PK tournament. What would you like to claim, 500,000 silver or a Dragon Ball?")
                ...
                if checkTime(client, 2, "1 21:30 1 22:27") then
                    ...
                    if alivePlayersOnMap(client, 1094) == 1 then
                    ...
                    if checkTime(client, 3, "6 21:30 6 22:27") then
                        ...
                        if checkTime(client, 2, "1 22:30 1 23:59") then
                            ...
                            if alivePlayersOnMap(client, 1095) == 1 then
