...
function processTask30026(client, idx)
    name = "StageGuard"
    face = 1

    if (idx == 0) then

        if hasItem(client, 721102, 1) then
    ...
    elseif (idx == 1) then
        ...
        if hasTaskItem(client, "PassToken3") and (getMoney(client) >= 0) then

            spendItem(client, 721102, 1)
