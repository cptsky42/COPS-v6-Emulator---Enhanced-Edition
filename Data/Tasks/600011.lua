...
function processTask600011(client, idx)
    name = "Ghost"
    face = 1
    ...
    elseif (idx == 1) then
        ...
        if hasItem(client, 721013, 1) then
            ...
            text(client, "Wow! You have a token for Prosperous Tactic. My only wish is to see a person break through the tactics. I hope you can succeed.")
    ...
    elseif (idx == 4) then
        ...
        text(client, "Although I cannot help you break through the tactics, but I can help you leave here. I hope you can conquer the tactics soon.")
