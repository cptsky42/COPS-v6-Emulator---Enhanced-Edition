...
function processTask30069(client, idx)
    name = "ProtectingKid"
    face = 1
    ...
    if (idx == 0) then
        ...
        elseif hasTaskItem(client, "CloudLock") and (getMoney(client) >= 0) then
    ...
    elseif (idx == 3) then
        ...
        if hasTaskItem(client, "CloudLock") and (getMoney(client) >= 0) then
            ...
            if (rand(client, 2) < 1) then
                ...
                moveNpc(client, 30069, 1061, 512, 322)
                moveNpc(client, 30092, 1061, 510, 324)
                spendItem(client, 721111, 1)
                action = randomAction(client, 1, 8)
                if action == 1 then
