...
-- the 5/10/2015 3:10:21 PM.
--
-- Please read the WARNING, DISCLAIMER and PATENTS
-- sections in the LICENSE file.
--

function Monster3623_OnDie(self, client)
    name = "DemonBat"
                ...
                if getUserStats(client, 61, 0) >= 1 then
                    ...
                    if getUserStats(client, 61, 0) == 1 then
                        ...
                        if getUserStats(client, 61, 1) >= 40000 then
                            ...
                            if getUserStats(client, 61, 1) >= 39500 then
                                ...
                                setUserStats(client, 61, 1, getUserStats(61, 1) + 500, true)
                                setUserStats(client, 61, 11, 1, true)

                            else

                                sendSysMsg(client, "The hill of grievance has sunk for 500 meters", 2005)
                                setUserStats(client, 61, 1, getUserStats(61, 1) + 500, true)
                                setUserStats(client, 61, 11, 1, true)
                        ...
                        getUserStats(client, 61, 0) == 3
                        dropItem(self, client, 722727)
                        sendSysMsg(client, "The shining Squama Bead has appeared in the evil dark mist.", 2011)
