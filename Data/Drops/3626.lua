...
function Monster3626_OnDie(self, client)
    name = "CarrionSkeleton"
            ...
            if getLevel(client) < 120 then
                ...
                if getUserStats(client, 61, 0) >= 1 then
                    ...
                    if getUserStats(client, 61, 1) >= 40000 then
                        ...
                        if getUserStats(client, 61, 1) >= 39980 then
                            ...
                            setUserStats(client, 61, 1, getUserStats(61, 1) + 20, true)
                            setUserStats(client, 61, 11, 1, true)

                        else

                            sendSysMsg(client, "The hill of grievance has sunk for 20 meters", 2005)
                            setUserStats(client, 61, 1, getUserStats(61, 1) + 20, true)
                            setUserStats(client, 61, 11, 1, true)
